# This file was originally auto-generated by O2 with contents hashing to d2c282f351e053df4aaf5b7cdc67e28b
use strict;

use Test::More qw(no_plan);
use O2::Script::Test::Common;

use_ok 'O2::Mgr::Object::Query::ConditionManager';

use O2 qw($context $config);

my @localeCodes = @{ $config->get('o2.locales') };
my $mgr = $context->getSingleton('O2::Mgr::Object::Query::ConditionManager');

my $newObj = $mgr->newObject();
$newObj->setMetaName('Test-script for O2::Obj::Object::Query::Condition/O2::Mgr::Object::Query::ConditionManager');
