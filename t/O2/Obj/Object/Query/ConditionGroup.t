# This file was originally auto-generated by O2 with contents hashing to f4698a37398c09cdfd48965aa1a10eda
use strict;

use Test::More qw(no_plan);
use O2::Script::Test::Common;

use_ok 'O2::Mgr::Object::Query::ConditionGroupManager';

use O2 qw($context $config);

my @localeCodes = @{ $config->get('o2.locales') };
my $mgr = $context->getSingleton('O2::Mgr::Object::Query::ConditionGroupManager');

my $newObj = $mgr->newObject();
$newObj->setMetaName('Test-script for O2::Obj::Object::Query::ConditionGroup/O2::Mgr::Object::Query::ConditionGroupManager');
...
$newObj->setJoinWith("Tes");
$newObj->setConditions( getTestObjectId(), getTestObjectId() );
$newObj->save();
...
is_deeply( [ $dbObj->getConditionIds() ], [ $newObj->getConditionIds() ], 'conditions retrieved ok.' );
