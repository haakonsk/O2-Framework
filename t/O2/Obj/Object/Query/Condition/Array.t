# This file was originally auto-generated by O2 with contents hashing to bcc929ab91fbd9688d939cd2d9478a82
use strict;

use Test::More qw(no_plan);
use O2::Script::Test::Common;

use_ok 'O2::Mgr::Object::Query::Condition::ArrayManager';

use O2 qw($context $config);

my @localeCodes = @{ $config->get('o2.locales') };
my $mgr = $context->getSingleton('O2::Mgr::Object::Query::Condition::ArrayManager');

my $newObj = $mgr->newObject();
$newObj->setMetaName('Test-script for O2::Obj::Object::Query::Condition::Array/O2::Mgr::Object::Query::Condition::ArrayManager');
