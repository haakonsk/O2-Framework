# This file was originally auto-generated by O2 with contents hashing to 0c825c3f8db5b5cdb0e9c77b5b771535
use strict;

use Test::More qw(no_plan);
use O2::Script::Test::Common;

use_ok 'O2::Mgr::Object::Query::Condition::HashManager';

use O2 qw($context $config);

my @localeCodes = @{ $config->get('o2.locales') };
my $mgr = $context->getSingleton('O2::Mgr::Object::Query::Condition::HashManager');

my $newObj = $mgr->newObject();
$newObj->setMetaName('Test-script for O2::Obj::Object::Query::Condition::Hash/O2::Mgr::Object::Query::Condition::HashManager');
