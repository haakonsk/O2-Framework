# This file was originally auto-generated by O2 with contents hashing to 134f274f81d5e1555dcfc88a5a96776e
use strict;

use Test::More qw(no_plan);
use O2::Script::Test::Common;

use_ok 'O2::Mgr::PersonManager';

use O2 qw($context $config);

my @localeCodes = @{ $config->get('o2.locales') };
my $mgr = $context->getSingleton('O2::Mgr::PersonManager');

my $newObj = $mgr->newObject();
$newObj->setMetaName('Test-script for O2::Obj::Person/O2::Mgr::PersonManager');
